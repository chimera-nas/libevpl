...
EVPL_HTTP_API struct evpl_http_agent *
evpl_http_init(
    struct evpl *evpl);

EVPL_HTTP_API void evpl_http_destroy(
...
EVPL_HTTP_API struct evpl_http_server *
evpl_http_attach(
    struct evpl_http_agent       *agent,
...
EVPL_HTTP_API struct evpl_http_conn *
 ...
 */
EVPL_HTTP_API struct evpl_http_request *
