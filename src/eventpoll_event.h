...
void eventpoll_event_mark_finish(struct eventpoll *eventpoll, struct eventpoll_event *event);
void eventpoll_event_mark_close(struct eventpoll *eventpoll, struct eventpoll_event *event);
